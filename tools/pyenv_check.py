...
The tools of anvilkit-agent-contracts run under the pinned CPython 3.12
environment that tools/verification-env.sh creates from tools/requirements.txt; a tool that
